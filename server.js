...
// ============================================================
// 1. SERVE STATIC FRONTEND FILES (Your index.html)
// ============================================================
...
if (process.env.FIREBASE_SERVICE_ACCOUNT) {
  // Render / Railway – use environment variable
  serviceAccount = JSON.parse(process.env.FIREBASE_SERVICE_ACCOUNT);
} else {
  // Local development – use the dummy file
...
// ============================================================
// 3. FLUTTERWAVE – Initialize (using environment variables)
// ============================================================
...
app.post('/api/vtu-proxy', async (req, res) => {
  try {
    ...
    // --- Call your VTU provider (VTPass example) ---
    const vtuPayload = {
      serviceID: serviceId,
      amount: amount,
      phone: phone,
...
app.post('/api/kyc-initiate', async (req, res) => {
  try {
    ...
    // --- Call your BVN provider (IdentityPass example) ---
    const payload = {
      bvn,
      firstname,
      lastname,
